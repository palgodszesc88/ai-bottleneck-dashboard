...
var SIGNAL_HISTORY = [
  ...
  { date: "15.IV", green: 2, blue: 34, yellow: 35, red: 16 }
];
...
const MOMENTUM_DATA = {
  ...
  "KAP":{ret12minus1:147.3,tsPositive:true,aboveSMA:true},
...
var MACRO_ALARMS = {
  ...
  indicators: [
    ...
    { id: "sofr_iorb", name: "SOFR-IORB Spread", value: -3, threshold_yellow: 15, threshold_red: 30, unit: "bps",
      ...
      source: "SOFR - IORB" },
    { id: "dxy", name: "DXY Dollar Index", value: 98.14, threshold_yellow: 105, threshold_red: 110, unit: "",
  ...
  return React.createElement("div", { style: { background: "rgba(99,102,241,0.06)", borderRadius: 12, padding: 16, marginBottom: 18, border: "1px solid rgba(99,102,241,0.2)" } },
    React.createElement("div", { onClick: function() { setExpanded(!expanded); }, style: { cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center" } },
      React.createElement("div", null,
        ...
        React.createElement("span", { style: { fontSize: 11, marginLeft: 8, opacity: 0.5 } }, "updated: "2026-04-15"div", { style: { display: "flex", alignItems: "center", gap: 8 } },
