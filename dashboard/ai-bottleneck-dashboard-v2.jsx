...
const MOMENTUM_DATA = {
  ...
  "AAPL":{ret12minus1:20,tsPositive:true,aboveSMA:true},
  ...
  "AMD":{ret12minus1:109,tsPositive:true,aboveSMA:true},
  ...
  "ASML":{ret12minus1:93.9,tsPositive:true,aboveSMA:true},
  ...
  "FNV":{ret12minus1:44.2,tsPositive:true,aboveSMA:true},
  "FSLR":{ret12minus1:56.8,tsPositive:true,aboveSMA:false},
  "GEV":{ret12minus1:136,tsPositive:true,aboveSMA:true},
  "GLW":{ret12minus1:211,tsPositive:true,aboveSMA:true},
  ...
  "IFX.DE":{ret12minus1:32.6,tsPositive:true,aboveSMA:true},
  ...
  "TER":{ret12minus1:301,tsPositive:true,aboveSMA:true},
...
var CATALYSTS = [
  ...
  { date: "2026-04-15", label: "ASML Q1 earnings — consensus €8.5B rev, EPS $7.49-7.72. Key: bookings, China % (norm do ~20%), MATCH Act, High-NA", type: "earnings", tickers: ["ASML"], impact: "high" },
  ...
  { date: "2026-04-29", label: "SCHN.PA Q1 + AMZN Q1 + QCOM Q2 + ARM Q4 + PWR Q1 + LLY Q1 + CCJ Q1 + TER Q1 + LRCX Q1", type: "earnings", tickers: ["SCHN.PA","AMZN","QCOM","ARM","PWR","LLY","CCJ","TER","LRCX"], impact: "high" },
  { date: "2026-04-30", label: "TT Q1 + MP Q1 + MU/WDC/SNDK Q3 + AAPL Q2 + CF Q1 + GDP Q1 + PCE Deflator", type: "earnings", tickers: ["TT","MP","MU","WDC","SNDK","AAPL","CF"], impact: "high" },
  ...
  { date: "2026-05-07", label: "CEG Q1 (guidance EPS $11-12, rozczarowuje) + LNG Q1 + WPM Q1 + RHM.DE Q1 + BE Q3 + POWL Q2", type: "earnings", tickers: ["CEG","LNG","WPM","RHM.DE","BE","POWL"], impact: "high" },
...
var MACRO_ALARMS = {
  updated: "2026-04-15",
  indicators: [
    { id: "move", name: "MOVE Index", value: 74.35, threshold_yellow: 100, threshold_red: 120, unit: "",
    ...
    { id: "sofr_iorb", name: "SOFR-IORB Spread", value: -3, threshold_yellow: 15, threshold_red: 30, unit: "bps",
      ...
      source: "SOFR - IORB" },
    { id: "dxy", name: "DXY Dollar Index", value: 98.17, threshold_yellow: 105, threshold_red: 110, unit: "",
      desc: "Dollar strength. Every 10% rise = -10% global liquidity (Howell). Ceasefire pushed below 100.",
      source: "ICE DXY" },
    { id: "vix", name: "VIX", value: 18.36, threshold_yellow: 30, threshold_red: 40, unit: "",
      desc: "Equity volatility. >30 = elevated fear. >40 = panic / correlation spike.",
      source: "CBOE VIX" },
    { id: "us10y", name: "US 10Y Yield", value: 4.26, threshold_yellow: 4.60, threshold_red: 5.00, unit: "%",
